...
ruleset. Escaping requires a kernel bug (see
...
### Network attacker (passive or active, on-path)
...
### Opportunistic physical access ("evil maid", stolen laptop)
...
### Cross-zone data leakage through user error
