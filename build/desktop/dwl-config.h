...
static const Rule rules[] = {
	...
	{ "kryptik.vault.",   NULL,       1 << 8,       0,           -1 }, /* the vault keeps to its own tag */
};
...
/* Alt, because Super is what the host grabs when this runs in a VM window. */
...
static const Key keys[] = {
	...
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_p,           spawn,            {.v = personalcmd} },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_u,           spawn,            {.v = untrustedcmd} },
